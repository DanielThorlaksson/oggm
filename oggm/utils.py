...
def single_glacier_characteristics(gdir):
    """Gathers as many statistics as possible about a single of glacier
    directory.

    To be merged with glacier_characteristics, that function will call this one
